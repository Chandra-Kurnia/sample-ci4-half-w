...
$routes->get('/manageUser/(:any)', 'Manage::getById/$1', ['filter' => 'authGuard']);
...
$routes->get('/manageEmployees', 'Manage::manageEmployees');
$routes->get('/manageProfile', 'Manage::manageProfile');
