        ...
        <div class="col-sm-auto bg-light sticky-top">
            <div class="d-flex flex-sm-column flex-row flex-nowrap bg-light align-items-center sticky-top">
                ...
                <ul class="nav nav-pills nav-flush flex-sm-column flex-row flex-nowrap mb-auto mx-auto text-center align-items-center">
                    ...
                    <li>
                        <a href="#" class="nav-link py-3 px-2" data-toggle="tooltip" data-placement="right" title="Manage Employees data">
                            <i class="bi-table fs-1"></i>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="nav-link py-3 px-2" data-toggle="tooltip" data-placement="right" title="Manage User Data">
                            <i class="bi-people fs-1"></i>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="nav-link py-3 px-2" data-toggle="tooltip" data-placement="right" title="Manage Profile">
